...
export function renderizarCatalogo() {
  for (const produtoCatalogo of catalogo) {
    const cartaoProduto = `<div class='border-solid w-48 m-2 flex flex-col p-2 justify-between shadow-xl hadow-slate-400 rounded-lg group ${produtoCatalogo.feminino}' id="card-produto-${produtoCatalogo.id}">
